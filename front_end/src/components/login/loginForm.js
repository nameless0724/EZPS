  ...
  return(
    <div>
       <form className="w-full max-w-sm" onSubmit={props.handleSubmit}>
          ...
          <div className="md:w-1/3">
          <input className="bg-gray-200 appearance-none border-2 border-gray-700 rounded w-full py-2 px-4 text-black leading-tight focus:outline-none focus:bg-white focus:border-lime-400" type="user_name" value={props.user_name} placeholder="User Name" onChange={props.handleUser_name} />
          </div><br />
          ...
          <div className="md:w-1/3">
          <input className="bg-gray-200 appearance-none border-2 border-gray-700 rounded w-full py-2 px-4 text-black leading-tight focus:outline-none focus:bg-white focus:border-lime-400" type="password" value={props.password} placeholder="Password" onChange={props.handlePassword} />
          </div><br />
